...
!BOP
!
! !MODULE: Merra2_A3MstEModule
!
! !DESCRIPTION: Module Merra2_A3MstEModule contains routines to create the 
!  GEOS-Chem average 3-hr data files from the MERRA2 raw data.
!\\
!\\
! !INTERFACE: 
...
100 FORMAT ( '%%% Defining netCDF file vars & attrs for ', a' grid' )
    ...
    ! Title string
    lName = 'MERRA2 time-averaged 3-hour moist parameters on level edges (A3mstE), processed for GEOS-Chem input'
...
!BOP
!
! !IROUTINE: Merra2_MakeA3MstE
!
! !DESCRIPTION: Routine Merra2_MakeA3MstE is the the driver routine for 
! \begin{enumerate}
...
!
    ...
    ! Echo info    
    msg = '%%%%%%%%%% ENTERING ROUTINE Merra2_MakeA3MstE %%%%%%%%%%'
    WRITE( IU_LOG, '(a)' )
    WRITE( IU_LOG, '(a)' ) TRIM( msg )
...
110 FORMAT( '%%% TOTAL # OF FIELDS TO BE REGRIDDED : ', i5 )
    ...
    ! Echo info
    msg = '%%%%%%%%%% LEAVING ROUTINE Merra2_MakeA3mstE %%%%%%%%%%'
    WRITE( IU_LOG, '(a)' ) '%%%'   
    WRITE( IU_LOG, '(a)' ) TRIM( msg )

  END SUBROUTINE Merra2_MakeA3MstE
!EOC
!------------------------------------------------------------------------------
!                  GEOS-Chem Global Chemical Transport Model                  !
!------------------------------------------------------------------------------
...
!
! !DESCRIPTION: Subroutine Process3dMstNe regrids the Merra2_ met fields from 
...
!EOC
END MODULE Merra2_A3MstEModule
